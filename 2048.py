...
class Frame(wx.Frame):
    ...
    def doMove(self,move,score):
        if move:
            ...
            if self.isGameOver():
                if wx.MessageBox(u"Game is over, restart a new one？",u"Lose",
    ...
    def drawLabel(self,dc):
        ...
        dc.SetTextForeground((119,110,101))
        dc.DrawText(u"Merge same number, towards 2048!",15,114)
        dc.DrawText(u"HOW TO PLAY: \nUse arrow keys to move the tiles. \nWhen two tiles with the same number touch, they merge into one!",15,639)
